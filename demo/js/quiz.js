let quizSession = null;
        ...
        function loadQuizMix() {
            try { const r = localStorage.getItem('demo_quiz_mix'); if (r) quizMix = { ...QUIZ_MIX_DEFAULT, ...JSON.parse(r) }; } catch (e) {}
        }
        function saveQuizMix() {
            try { localStorage.setItem('demo_quiz_mix', JSON.stringify(quizMix)); } catch (e) {}
        }
