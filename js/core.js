let vocabulary = [];
        ...
        function changeTab(tabId) {
            ...
            Object.keys(btns).forEach(key => {
                ...
                if (key === tabId) {
                    el.className = hiddenPrefix + "w-full flex items-center gap-3 px-4 py-3 rounded-xl text-left text-sm font-bold transition-all bg-violet-600 text-white shadow-md shadow-violet-100";
                } else {
                    el.className = hiddenPrefix + "w-full flex items-center gap-3 px-4 py-3 rounded-xl text-left text-sm font-medium transition-all text-slate-600 hover:bg-slate-50";
                }
            });
